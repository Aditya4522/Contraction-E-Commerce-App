        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            <Card className="p-6 dark:bg-gray-800">
              <h1 className="text-2xl font-semibold mb-6 dark:text-white">Order Summary</h1>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="pt-4 border-t dark:border-gray-700">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-yellow-600">₹599</span>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="lg:w-[450px]">
            <Card className="p-6 dark:bg-gray-800">
              <h2 className="text-2xl font-semibold mb-6 dark:text-white">Billing Information</h2>
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="address" className="text-sm font-medium dark:text-gray-200">
                    Shipping Address
                  </Label>
                  <Textarea
                    id="address"
